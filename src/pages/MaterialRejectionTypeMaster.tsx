...
const MaterialRejectionTypeMaster = () => {
                ...
                <div className="p-8">
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-foreground mb-2">Material Rejection Type Master</h1>
                                <p className="text-muted-foreground">Configure and categorize reasons for material rejection in the inventory</p>
                            </div>
                            <Button
                            ...
                            >
                                ...
                                Add New Material Rejection Type
                            </Button>
                        </div>
                    </motion.div>
                            ...
                            <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden">
                                ...
                                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <Input name="description" value={formData.description} onChange={handleInputChange} placeholder="e.g. PHYSICAL BREAKAGE OR CONTAINER LEAKAGE" required />
                                    </div>
...
export default MaterialRejectionTypeMaster;

...
const ProductStatusMaster = () => {
    const [searchQuery, setSearchQuery] = useState("");
    const [isAddModalOpen, setIsAddModalOpen] = useState(false);
    const [formData, setFormData] = useState({
        name: "",
        description: "",
        stockEffect: "ADD" as "ADD" | "SUBTRACT",
        active: true,
    });
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="relative">
                                    <button className="flex items-center gap-2 px-4 py-2 border border-border rounded-lg bg-background hover:bg-muted/50 transition-colors">
                                        <span className="text-sm font-medium">Impact on Stock</span>
                            ...
                            <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden">
                                ...
                                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <Input name="description" value={formData.description} onChange={handleInputChange} placeholder="e.g. READY FOR SALE" required />
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        >
                                            ...
                                            <option value="SUBTRACT">NO EFFECT / SUBTRACT (Red)</option>
                                        </select>
                                    </div>

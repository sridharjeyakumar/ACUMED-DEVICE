...
function computeActualResult(row: DetailRow): string {
  ...
  // 'P' type — manual entry, return as-is
            ...
            return (
              <tr key={row.checklist_sno} className="hover:bg-muted/20">
                ...
                <td className="px-3 py-2 text-center text-xs font-mono">
                  {row.expected_value_1 !== undefined ? row.expected_value_1 : '-'}
                </td>
                <td className="px-3 py-2 text-center text-xs font-mono">
                  {row.expected_value_2 !== undefined ? row.expected_value_2 : '-'}
                </td>
                ...
                <td className="px-3 py-2 text-center">
                  {isValueEntry ? (
                    <Input
                      ...
                      onChange={e => handleDetailChange(idx, 'actual_value', e.target.value)}
                ...
                <td className="px-3 py-2">
                  {isTextEntry ? (
                    <Input
                      value={row.actual_text}
                      onChange={e => handleDetailChange(idx, 'actual_text', e.target.value)}
                      maxLength={25}
                ...
                <td className="px-3 py-2 text-center">
                  {isResultEntry ? (
                    <select
                      ...
                      onChange={e => handleDetailChange(idx, 'actual_result', e.target.value)}
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-border">
                    {loading ? (
                      ...
                      <tr><td colSpan={9} className="px-4 py-8 text-center text-muted-foreground">No COA records found</td></tr>
                        ...
                        <AnimatePresence>
                          {expandedRows.has(coa.coa_no) && (
                            <motion.tr
                              ...
                              exit={{ opacity: 0 }}
                            >
                              <td colSpan={9} className="px-6 py-4 bg-muted/10 border-b border-border">
              ...
              <div className="bg-white rounded-lg shadow-2xl w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                  ...
                  <div>
                    ...
                    {renderDetailTable(approvalDetails, true)}
                  </div>
                  ...
                  <div className="flex justify-end gap-3 pt-4 border-t border-border">
                    ...
                    <Button
                      ...
                      className="bg-red-600 hover:bg-red-700 text-white px-5 flex items-center gap-2"
                    >
                    ...
                    <Button
                      ...
                      className="bg-green-600 hover:bg-green-700 text-white px-5 flex items-center gap-2"
                    >

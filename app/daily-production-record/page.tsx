...
export default function DailyProductionRecordPage() {
                ...
                <div className="p-4 md:p-6 lg:p-8">
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Daily Production Record</h1>
                                <p className="text-sm md:text-base text-muted-foreground">Monitor and log daily manufacturing output and performance metrics</p>
                            </div>
                            <Button
                                                        ...
                                                        <div className="flex flex-wrap gap-3 max-h-48 overflow-y-auto">
                                                            <div className="flex items-center space-x-2">
                                                                <input 
                                                                    type="radio" 
                                                                    id="dpr-product-all" 
                                                                    name="dprProductFilter"
                                                                    checked={filterProduct === "all"}
                                                                    onChange={() => setFilterProduct("all")}
                                                                    className="h-4 w-4"
                                                                />
                                                                <Label htmlFor="dpr-product-all" className="text-sm font-normal cursor-pointer">All</Label>
                                                            </div>
                                                            {uniqueProducts.map((prod) => (
                                                                <div key={prod} className="flex items-center space-x-2">
                                                                    <input 
                                                                        ...
                                                                        className="h-4 w-4"
                                                                    />
                                                                    <Label htmlFor={`dpr-product-${prod}`} className="text-sm font-normal cursor-pointer">{prod}</Label>
                                                                </div>
                                                            ))}
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className="flex flex-wrap gap-3 max-h-48 overflow-y-auto">
                                                            <div className="flex items-center space-x-2">
                                                                <input 
                                                                    type="radio" 
                                                                    id="dpr-packsize-all" 
                                                                    name="dprPackSizeFilter"
                                                                    checked={filterPackSize === "all"}
                                                                    onChange={() => setFilterPackSize("all")}
                                                                    className="h-4 w-4"
                                                                />
                                                                <Label htmlFor="dpr-packsize-all" className="text-sm font-normal cursor-pointer">All</Label>
                                                            </div>
                                                            {uniquePackSizes.map((ps) => (
                                                                <div key={ps} className="flex items-center space-x-2">
                                                                    <input 
                                                                        ...
                                                                        className="h-4 w-4"
                                                                    />
                                                                    <Label htmlFor={`dpr-packsize-${ps}`} className="text-sm font-normal cursor-pointer">{ps}</Label>
                                                                </div>
                                                            ))}
                                                        </div>
                                                    </div>

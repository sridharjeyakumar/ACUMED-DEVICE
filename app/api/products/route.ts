...
export async function POST(request: NextRequest) {
  try {
    ...
    const product = new ProductMaster({ 
      ...
      qc_required: body.qc_required === true || body.qc_required === "true" ? 'Y' : (body.qc_required === 'Y' ? 'Y' : 'N'),
      sterilization_required: body.sterilization_required === true || body.sterilization_required === "true" ? 'Y' : (body.sterilization_required === 'Y' ? 'Y' : 'N'),

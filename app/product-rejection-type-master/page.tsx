...
export default function ProductRejectionTypeMasterPage() {
                ...
                <div className="p-4 md:p-6 lg:p-8">
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Product Rejection Type Master</h1>
                                <p className="text-sm md:text-base text-muted-foreground">Configure and categorize reasons for product rejection</p>
                            </div>
                            <Button
                            ...
                            >
                                ...
                                <span className="whitespace-nowrap">Add New Rejection Type</span>
                            </Button>
                        </div>
                    </motion.div>
                            ...
                            <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden">
                                ...
                                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <Input name="description" value={formData.description} onChange={handleInputChange} placeholder="e.g. VISIBLE CRACKS OR BREAKS" />
                                    </div>
                                    <div className="mb-4">
                ...
                {isEditModalOpen && (
                    <>
                        ...
                        >
                            <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden">
                                <div className="bg-blue-600 text-white px-6 py-4 flex items-center justify-between">
                                    <h2 className="text-2xl font-bold">Edit Rejection Type</h2>
                                    <button
                                        onClick={() => setIsEditModalOpen(false)}
                                        className="text-white hover:bg-blue-700 rounded-lg p-2 transition-colors"
                                    >
